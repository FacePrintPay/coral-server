...
## 🚀 Overview
**coral-server** is a critical component of the **Constellation25 Ecosystem**, engineered by CyGeL White. This build provides **Advanced Biometric Authentication Engine** capabilities designed for sovereignty, security, and scalability.
...
## 📦 Installation
```bash
git clone https://github.com/FacePrintPay/coral-server.git
cd coral-server
